...
const AREAS = [
  ...
  { part:"Part 9", id:"route-41", name:"Route 41",
    ...
    pokemon:[
      {name:"Tentacool",  method:"Surf",     levels:"15–25", rate:"60%", hgOnly:true},
      {name:"Tentacool",  method:"Surf",     levels:"15–25", rate:"90%", ssOnly:true},
      {name:"Tentacruel", method:"Surf",     levels:"15–25", rate:"30%", hgOnly:true},
      {name:"Tentacruel", method:"Surf",     levels:"15–25", rate:"10%", ssOnly:true},
  ...
  { part:"Part 10", id:"route-42", name:"Route 42",
    ...
    pokemon:[
      {name:"Spearow",   method:"Grass",   levels:"14–16", rate:"30%", hgOnly:true,  time:"morning", note:"Morning/Day HG only"},
      {name:"Spearow",   method:"Grass",   levels:"14–16", rate:"40%", ssOnly:true,  time:"morning", note:"Morning/Day SS only"},
      {name:"Zubat",     method:"Grass",   levels:"14–16", rate:"30%", hgOnly:true,  time:"night",   note:"Night HG only"},
      {name:"Zubat",     method:"Grass",   levels:"14–16", rate:"40%", ssOnly:true,  time:"night",   note:"Night SS only"},
      {name:"Mankey",    method:"Grass",   levels:"15",    rate:"30%", hgOnly:true},
      {name:"Mareep",    method:"Grass",   levels:"13",    rate:"30%", hgOnly:true},
      {name:"Mareep",    method:"Grass",   levels:"13–15", rate:"50%", ssOnly:true},
  ...
  { part:"Part 12", id:"ice-path", name:"Ice Path",
    ...
    floors:[
      { label:"1F", pokemon:[
        {name:"Zubat",    method:"Cave", levels:"22", rate:"25%", hgOnly:true,  time:"morning", note:"Morning/Night HG"},
        {name:"Zubat",    method:"Cave", levels:"22", rate:"5%",  ssOnly:true,  time:"morning", note:"Morning/Night SS"},
      ...
      { label:"B1F", pokemon:[
        {name:"Zubat",    method:"Cave", levels:"22", rate:"25%", hgOnly:true,  time:"morning"},
        {name:"Zubat",    method:"Cave", levels:"22", rate:"5%",  ssOnly:true,  time:"morning"},
        {name:"Golbat",   method:"Cave", levels:"22", rate:"30%"},
      ...
      { label:"B2F", pokemon:[
        {name:"Zubat",    method:"Cave", levels:"23", rate:"25%", hgOnly:true,  time:"morning"},
        {name:"Zubat",    method:"Cave", levels:"23", rate:"5%",  ssOnly:true,  time:"morning"},
  ...
  { part:"Part 13", id:"route-45", name:"Route 45",
    ...
    pokemon:[
      ...
      {name:"Graveler", method:"Grass",   levels:"23–27", rate:"40%", hgOnly:true},
      {name:"Graveler", method:"Grass",   levels:"23–25", rate:"55%", ssOnly:true},
  ...
  { part:"Part 15", id:"route-27", name:"Route 27",
    ...
    pokemon:[
      ...
      {name:"Doduo",     method:"Grass",   levels:"28–30", rate:"50%", hgOnly:true, time:"morning", note:"Morning/Day HG"},
      {name:"Doduo",     method:"Grass",   levels:"28–30", rate:"40%", ssOnly:true, time:"morning", note:"Morning/Day SS"},
      {name:"Quagsire",  method:"Grass",   levels:"28–30", rate:"50%", hgOnly:true, time:"night",   note:"Night HG"},
      {name:"Quagsire",  method:"Grass",   levels:"28–30", rate:"55%", ssOnly:true, time:"night",   note:"Night SS"},
  ...
  { part:"Part 15", id:"route-26", name:"Route 26",
    ...
    pokemon:[
      {name:"Raticate",  method:"Grass",   levels:"28–30", rate:"35%", hgOnly:true, time:"morning", note:"Morning/Day HG"},
      {name:"Raticate",  method:"Grass",   levels:"28–30", rate:"35%", ssOnly:true, time:"morning", note:"Morning/Day SS"},
      {name:"Raticate",  method:"Grass",   levels:"28–30", rate:"35%", hgOnly:true, time:"night",   note:"Night HG"},
      {name:"Raticate",  method:"Grass",   levels:"28",    rate:"65%", ssOnly:true, time:"night",   note:"Night SS"},
      ...
      {name:"Quagsire",  method:"Grass",   levels:"30",    rate:"10%", hgOnly:true, time:"night"},
      {name:"Quagsire",  method:"Grass",   levels:"30",    rate:"5%",  ssOnly:true, time:"night"},
  ...
  { part:"Part 18", id:"route-6", name:"Route 6",
    ...
    pokemon:[
      ...
      {name:"Oddish", method:"Grass", levels:"13", rate:"10%", time:"night", hgOnly:true},
      {name:"Oddish", method:"Grass", levels:"13", rate:"10%", time:"night", ssOnly:true},
  ...
  { part:"Part 19", id:"route-8", name:"Route 8",
    ...
    pokemon:[
      {name:"Pidgeotto", method:"Grass", levels:"22–25", rate:"HG 65%/SS 35% (morning/day)", hgOnly:true, time:"morning"},
      {name:"Pidgeotto", method:"Grass", levels:"22–25", rate:"HG 65%/SS 35% (morning/day)", hgOnly:true, time:"day"},
      {name:"Pidgeotto", method:"Grass", levels:"22", rate:"35% (morning/day)", ssOnly:true, time:"morning"},
      {name:"Pidgeotto", method:"Grass", levels:"22", rate:"35% (morning/day)", ssOnly:true, time:"day"},
  ...
  { part:"Part 20", id:"route-5", name:"Route 5",
    ...
    pokemon:[
      {name:"Pidgey", method:"Grass", levels:"13", rate:"HG 60%/SS 40% (morning/day)", hgOnly:true, time:"morning"},
      {name:"Pidgey", method:"Grass", levels:"13", rate:"HG 60%/SS 40% (morning/day)", hgOnly:true, time:"day"},
      {name:"Pidgey", method:"Grass", levels:"13", rate:"40% (morning/day)", ssOnly:true, time:"morning"},
      {name:"Pidgey", method:"Grass", levels:"13", rate:"40% (morning/day)", ssOnly:true, time:"day"},
  ...
  { part:"Part 31", id:"route-48", name:"Route 48",
    ...
    pokemon:[
      ...
      {name:"Farfetch'd", method:"Grass", levels:"25", rate:"20% (morning/day)", hgOnly:true, time:"morning"},
      {name:"Farfetch'd", method:"Grass", levels:"24", rate:"20% (morning/day)", ssOnly:true, time:"morning"},
  ...
  { part:"Part 31", id:"safari-zone-gate", name:"Safari Zone Gate",
    note:"Entrance area with Pokémon Center and market stalls. Poké Balls and vitamins sold here.",
    pokemon:[
      {name:"Hoothoot", method:"Headbutt (Common)", levels:"14–16", rate:"50%"},
      {name:"Pineco", method:"Headbutt (Common)", levels:"14–16", rate:"30%"},
      {name:"Exeggcute", method:"Headbutt (Common)", levels:"14–16", rate:"20%"},
  ...
  { part:"Part 31", id:"safari-zone", name:"Safari Zone",
    note:"Six customizable areas. ₽500 per session, 30 Safari Balls. Catch Geodude (Peak Area) then Sandshrew (Desert Area) for Owner Aptitude Test. Object Arrangement unlocked over time.",
    pokemon:[
      {name:"Geodude", method:"Grass", levels:"15–20", rate:"Peak Area (always first)", note:"Required for first Owner Aptitude Test"},
      {name:"Sandshrew", method:"Grass", levels:"15–20", rate:"Desert Area (must be added via customizer)", note:"Required for second Owner Aptitude Test — Desert Area not in default layout"},
    ],
    items:[],
    trainers:[] },
