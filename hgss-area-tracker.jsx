...
const DT_CANDIDATES = [
  ...
  { name:"Togekiss",    types:["Normal","Flying"],  hms:["Fly","Rock Smash"] },
  ...
  { name:"Ambipom",     types:["Normal"],           hms:["Cut","Strength","Rock Smash"] },
  { name:"Yanmega",     types:["Bug","Flying"],     hms:[] },
...
const DT_HM_COMPAT = {
  "Cut":        new Set(["Meganium","Bayleef","Chikorita","Heracross","Furret","Sentret","Scyther","Scizor","Pinsir","Sneasel","Aipom","Ambipom","Farfetch'd","Nidoking","Nidorino","Nidoran♂","Nidoqueen","Nidorina","Nidoran♀","Golduck","Psyduck","Kingler","Krabby","Kabutops","Kabuto","Kangaskhan","Rhydon","Rhyhorn","Dodrio","Doduo","Venomoth","Venonat","Bellossom","Gloom","Oddish","Tangrowth","Tangela","Vileplume","Skarmory","Dugtrio","Diglett","Persian","Meowth","Sunflora","Sunkern","Seaking","Goldeen","Feraligatr","Croconaw","Totodile","Dragonite","Dragonair","Dratini","Typhlosion","Quilava","Cyndaquil","Steelix","Onix","Tyranitar","Pupitar","Larvitar","Espeon","Umbreon","Ursaring","Teddiursa","Gligar"]),
  "Fly":        new Set(["Noctowl","Hoothoot","Crobat","Golbat","Xatu","Natu","Togekiss","Togetic","Togepi","Skarmory","Delibird","Dragonite","Dragonair","Aerodactyl","Dodrio","Doduo","Murkrow"]),
  ...
  "Rock Climb": new Set(["Tyranitar","Pupitar","Larvitar","Steelix","Onix","Ursaring","Teddiursa","Snorlax","Machamp","Machoke","Nidoking","Nidoqueen","Dragonite","Kangaskhan","Mamoswine","Aerodactyl","Primeape","Mankey","Rhydon","Rhyhorn","Typhlosion","Quilava","Cyndaquil","Meganium","Bayleef","Chikorita","Feraligatr","Croconaw","Totodile","Ampharos","Flaaffy","Blissey","Chansey","Granbull","Snubbull"]),
};
