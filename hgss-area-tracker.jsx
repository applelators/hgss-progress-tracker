...
const AREAS = [
  ...
  { part:"Part 10", id:"safari-zone-gate", name:"Safari Zone Gate",
    note:"Entrance area with Pokémon Center and market stalls. Opens after healing Amphy at Olivine Lighthouse. Safari Zone: ₽500 entry, 30 loaned Safari Balls, no time/step limit. Six areas active per session (chosen from 12). Block objects placed in areas unlock additional Pokémon once block-point thresholds are met.",
    pokemon:[
  ...
  { part:"Part 10", id:"safari-zone-peak", name:"Safari Zone: Peak Area",
    image:"https://archives.bulbagarden.net/media/upload/2/2f/Johto_Safari_Zone_Peak_HGSS.png",
    note:"Always the first area — required for Aptitude Test 1 (catch a Geodude here). Block placement unlocks after National Pokédex + 3 hrs after Test 2.",
    items:[], trainers:[], pokemon:[
      {name:"Geodude",   method:"Grass", levels:"15–17", rate:"40%"},
      {name:"Graveler",  method:"Grass", levels:"16–17", rate:"20%", time:"morning"},
      {name:"Graveler",  method:"Grass", levels:"16–17", rate:"20%", time:"day"},
      {name:"Magnemite", method:"Grass", levels:"15–16", rate:"20%"},
      {name:"Magneton",  method:"Grass", levels:"17",    rate:"10%", time:"morning"},
      {name:"Magneton",  method:"Grass", levels:"17",    rate:"10%", time:"day"},
      {name:"Magneton",  method:"Grass", levels:"17",    rate:"20%", time:"night"},
      {name:"Magmar",    method:"Grass", levels:"17",    rate:"10%", time:"morning"},
      {name:"Magmar",    method:"Grass", levels:"17",    rate:"10%", time:"day"},
  ...
  { part:"Part 10", id:"safari-zone-desert", name:"Safari Zone: Desert Area",
    image:"https://archives.bulbagarden.net/media/upload/d/d6/Johto_Safari_Zone_Desert_HGSS.png",
    note:"Required for Aptitude Test 2 (catch a Sandshrew) — add via Area Customizer first. Test 2 unlocks ~3 hrs after Test 1.",
    items:[], trainers:[], pokemon:[
      {name:"Sandshrew", method:"Grass", levels:"15–17", rate:"40%"},
      {name:"Sandslash", method:"Grass", levels:"15–17", rate:"30%"},
      {name:"Cubone",    method:"Grass", levels:"16–17", rate:"20%", time:"morning"},
      {name:"Cubone",    method:"Grass", levels:"16–17", rate:"20%", time:"day"},
      {name:"Marowak",   method:"Grass", levels:"17",    rate:"10%", time:"morning"},
      {name:"Marowak",   method:"Grass", levels:"17",    rate:"10%", time:"day"},
  ...
  { part:"Part 10", id:"safari-zone-plains", name:"Safari Zone: Plains Area",
    image:"https://archives.bulbagarden.net/media/upload/1/1a/Johto_Safari_Zone_Plains_HGSS.png",
    note:"Open grassland. Smeargle is exclusive here — catch one for your dedicated catcher (morning/day only).",
    items:[], trainers:[], pokemon:[
      {name:"Abra",      method:"Grass", levels:"15–17", rate:"30%"},
      {name:"Rattata",   method:"Grass", levels:"15–17", rate:"30%", time:"morning"},
      {name:"Rattata",   method:"Grass", levels:"15–17", rate:"30%", time:"day"},
      {name:"Girafarig", method:"Grass", levels:"15–17", rate:"30%", time:"morning"},
      {name:"Girafarig", method:"Grass", levels:"15–17", rate:"30%", time:"day"},
      {name:"Smeargle",  method:"Grass", levels:"17",    rate:"10%", time:"morning"},
      {name:"Smeargle",  method:"Grass", levels:"17",    rate:"10%", time:"day"},
      {name:"Raticate",  method:"Grass", levels:"15–17", rate:"30%", time:"night"},
      {name:"Girafarig", method:"Grass", levels:"15–16", rate:"20%", time:"night"},
  ...
  { part:"Part 10", id:"safari-zone-meadow", name:"Safari Zone: Meadow Area",
    image:"https://archives.bulbagarden.net/media/upload/e/e9/Johto_Safari_Zone_Meadow_HGSS.png",
    note:"Water area. Sunkern is SS-only (morning/day). Jigglypuff is 50% in HG vs 30% in SS morning/day. Riolu requires extreme block investment.",
    items:[], trainers:[], pokemon:[
      {name:"Jigglypuff", method:"Grass",     levels:"15–17", rate:"50%", time:"morning"},
      {name:"Jigglypuff", method:"Grass",     levels:"15–17", rate:"50%", time:"day"},
      {name:"Jigglypuff", method:"Grass",     levels:"15–17", rate:"30%", time:"night"},
      {name:"Hoppip",     method:"Grass",     levels:"15–17", rate:"40%", time:"morning"},
      {name:"Hoppip",     method:"Grass",     levels:"15–17", rate:"40%", time:"day"},
      {name:"Skiploom",   method:"Grass",     levels:"17",    rate:"10%", time:"morning"},
      {name:"Skiploom",   method:"Grass",     levels:"17",    rate:"10%", time:"day"},
      {name:"Sunkern",    method:"Grass",     levels:"15–17", rate:"30%", ssOnly:true, time:"morning"},
      {name:"Sunkern",    method:"Grass",     levels:"15–17", rate:"30%", ssOnly:true, time:"day"},
      ...
      {name:"Geodude",    method:"Grass",     levels:"45",    note:"Blocks: 3 Peak"},
  ...
  { part:"Part 10", id:"safari-zone-forest", name:"Safari Zone: Forest Area",
    image:"https://archives.bulbagarden.net/media/upload/b/b7/Johto_Safari_Zone_Forest_HGSS.png",
    note:"Dense woodland. Misdreavus has different rates day vs night (10% morning/day, 30% night). Beldum and Bronzong require extreme block investment.",
    items:[], trainers:[], pokemon:[
      {name:"Bellsprout", method:"Grass", levels:"15–17", rate:"40%", time:"morning"},
      {name:"Bellsprout", method:"Grass", levels:"15–17", rate:"40%", time:"day"},
      {name:"Bellsprout", method:"Grass", levels:"15–17", rate:"30%", time:"night"},
      {name:"Pidgey",     method:"Grass", levels:"15–17", rate:"30%", time:"morning"},
      {name:"Pidgey",     method:"Grass", levels:"15–17", rate:"30%", time:"day"},
      {name:"Mr. Mime",   method:"Grass", levels:"16–17", rate:"20%", time:"morning"},
      {name:"Mr. Mime",   method:"Grass", levels:"16–17", rate:"20%", time:"day"},
      {name:"Misdreavus", method:"Grass", levels:"15–17", rate:"10%", time:"morning"},
      {name:"Misdreavus", method:"Grass", levels:"15–17", rate:"10%", time:"day"},
      {name:"Misdreavus", method:"Grass", levels:"15–17", rate:"30%", time:"night"},
  ...
  { part:"Part 10", id:"safari-zone-swamp", name:"Safari Zone: Swamp Area",
    image:"https://archives.bulbagarden.net/media/upload/b/b5/Johto_Safari_Zone_Swamp_HGSS.png",
    note:"Water area with fishing. Murkrow is rarer in the morning/day (10%) but common at night (30%). Bagon requires extreme block investment.",
    items:[], trainers:[], pokemon:[
      {name:"Sentret",    method:"Grass",     levels:"15–17", rate:"30%"},
      {name:"Jigglypuff", method:"Grass",     levels:"15–17", rate:"30%", time:"morning"},
      {name:"Jigglypuff", method:"Grass",     levels:"15–17", rate:"30%", time:"day"},
      {name:"Paras",      method:"Grass",     levels:"15–17", rate:"30%", time:"morning"},
      {name:"Paras",      method:"Grass",     levels:"15–17", rate:"30%", time:"day"},
      {name:"Murkrow",    method:"Grass",     levels:"17",    rate:"10%", time:"morning"},
      {name:"Murkrow",    method:"Grass",     levels:"17",    rate:"10%", time:"day"},
  ...
  { part:"Part 10", id:"safari-zone-marshland", name:"Safari Zone: Marshland Area",
    image:"https://archives.bulbagarden.net/media/upload/b/bd/Johto_Safari_Zone_Marshland_HGSS.png",
    note:"Water area with fishing. Koffing is available at all times; most others are time-restricted.",
    items:[], trainers:[], pokemon:[
      {name:"Koffing",   method:"Grass",     levels:"15–17", rate:"30%"},
      {name:"Weezing",   method:"Grass",     levels:"15–17", rate:"30%", time:"morning"},
      {name:"Weezing",   method:"Grass",     levels:"15–17", rate:"30%", time:"day"},
      {name:"Ekans",     method:"Grass",     levels:"15–16", rate:"20%", time:"morning"},
      {name:"Ekans",     method:"Grass",     levels:"15–16", rate:"20%", time:"day"},
      {name:"Arbok",     method:"Grass",     levels:"17",    rate:"10%", time:"morning"},
      {name:"Arbok",     method:"Grass",     levels:"17",    rate:"10%", time:"day"},
      {name:"Grimer",    method:"Grass",     levels:"17",    rate:"10%", time:"morning"},
      {name:"Grimer",    method:"Grass",     levels:"17",    rate:"10%", time:"day"},
  ...
  { part:"Part 10", id:"safari-zone-mountain", name:"Safari Zone: Mountain Area",
    image:"https://archives.bulbagarden.net/media/upload/b/b7/Johto_Safari_Zone_Mountain_HGSS.png",
    note:"Rocky highland. Larvitar only appears morning/day. Rattata and Magneton available at all times.",
    items:[], trainers:[], pokemon:[
      {name:"Rattata",   method:"Grass", levels:"15–16", rate:"20%"},
      {name:"Magneton",  method:"Grass", levels:"17",    rate:"10%"},
      {name:"Raticate",  method:"Grass", levels:"15–17", rate:"30%", time:"morning"},
      {name:"Raticate",  method:"Grass", levels:"15–17", rate:"30%", time:"day"},
      {name:"Lickitung", method:"Grass", levels:"15–17", rate:"30%", time:"morning"},
      {name:"Lickitung", method:"Grass", levels:"15–17", rate:"30%", time:"day"},
      {name:"Larvitar",  method:"Grass", levels:"17",    rate:"10%", time:"morning"},
      {name:"Larvitar",  method:"Grass", levels:"17",    rate:"10%", time:"day"},
  ...
  { part:"Part 10", id:"safari-zone-rocky-beach", name:"Safari Zone: Rocky Beach Area",
    image:"https://archives.bulbagarden.net/media/upload/e/e6/Johto_Safari_Zone_Rocky_Beach_HGSS.png",
    note:"Coastal area with Surf and fishing. Slowpoke, Slowbro, and Krabby are available at all times. Doduo is morning/day only.",
    items:[], trainers:[], pokemon:[
      ...
      {name:"Doduo",     method:"Grass",     levels:"15–17", rate:"30%", time:"morning"},
      {name:"Doduo",     method:"Grass",     levels:"15–17", rate:"30%", time:"day"},
  ...
  { part:"Part 10", id:"safari-zone-wasteland", name:"Safari Zone: Wasteland Area",
    image:"https://archives.bulbagarden.net/media/upload/8/85/Johto_Safari_Zone_Wasteland_HGSS.png",
    note:"Onix is HG morning/day 20% or SS morning/day 30%; at night it appears in both at 40%. Machoke is HG morning/day only. Kangaskhan is morning/day only.",
    items:[], trainers:[], pokemon:[
      {name:"Magnemite",  method:"Grass", levels:"15–17", rate:"30%"},
      {name:"Onix",       method:"Grass", levels:"15–16", rate:"20%", hgOnly:true, time:"morning"},
      {name:"Onix",       method:"Grass", levels:"15–16", rate:"20%", hgOnly:true, time:"day"},
      {name:"Onix",       method:"Grass", levels:"15–17", rate:"30%", ssOnly:true, time:"morning"},
      {name:"Onix",       method:"Grass", levels:"15–17", rate:"30%", ssOnly:true, time:"day"},
      {name:"Onix",       method:"Grass", levels:"15–17", rate:"40%", time:"night"},
      {name:"Kangaskhan", method:"Grass", levels:"15–17", rate:"20%", time:"morning"},
      {name:"Kangaskhan", method:"Grass", levels:"15–17", rate:"20%", time:"day"},
      {name:"Machop",     method:"Grass", levels:"16–17", rate:"20%", time:"morning"},
      {name:"Machop",     method:"Grass", levels:"16–17", rate:"20%", time:"day"},
      {name:"Machoke",    method:"Grass", levels:"17",    rate:"10%", hgOnly:true, time:"morning"},
      {name:"Machoke",    method:"Grass", levels:"17",    rate:"10%", hgOnly:true, time:"day"},
      {name:"Fearow",     method:"Grass", levels:"15–17", rate:"30%", time:"night"},
  ...
  { part:"Part 10", id:"safari-zone-savannah", name:"Safari Zone: Savannah Area",
    image:"https://archives.bulbagarden.net/media/upload/e/e2/Johto_Safari_Zone_Savannah_HGSS.png",
    note:"Open savannah. All base-pool Pokémon are strictly time-separated: Nidoran/Tauros/Rhyhorn by day, Nidorina/Nidorino/Zubat/Golbat by night.",
    items:[], trainers:[], pokemon:[
      {name:"Nidoran♀",  method:"Grass", levels:"15–17", rate:"30%", time:"morning"},
      {name:"Nidoran♀",  method:"Grass", levels:"15–17", rate:"30%", time:"day"},
      {name:"Nidoran♂",  method:"Grass", levels:"15–17", rate:"30%", time:"morning"},
      {name:"Nidoran♂",  method:"Grass", levels:"15–17", rate:"30%", time:"day"},
      {name:"Tauros",    method:"Grass", levels:"15–17", rate:"30%", time:"morning"},
      {name:"Tauros",    method:"Grass", levels:"15–17", rate:"30%", time:"day"},
      {name:"Rhyhorn",   method:"Grass", levels:"17",    rate:"10%", time:"morning"},
      {name:"Rhyhorn",   method:"Grass", levels:"17",    rate:"10%", time:"day"},
  ...
  { part:"Part 10", id:"safari-zone-wetland", name:"Safari Zone: Wetland Area",
    image:"https://archives.bulbagarden.net/media/upload/a/aa/Johto_Safari_Zone_Wetland_HGSS.png",
    note:"Water area with fishing. Farfetch'd, Sentret, Spearow, and Ditto are morning/day only. Night pool is entirely water-type.",
    items:[], trainers:[], pokemon:[
      {name:"Farfetch'd", method:"Grass",     levels:"15–17", rate:"30%", time:"morning"},
      {name:"Farfetch'd", method:"Grass",     levels:"15–17", rate:"30%", time:"day"},
      {name:"Sentret",    method:"Grass",     levels:"15–17", rate:"30%", time:"morning"},
      {name:"Sentret",    method:"Grass",     levels:"15–17", rate:"30%", time:"day"},
      {name:"Spearow",    method:"Grass",     levels:"15–17", rate:"30%", time:"morning"},
      {name:"Spearow",    method:"Grass",     levels:"15–17", rate:"30%", time:"day"},
      {name:"Ditto",      method:"Grass",     levels:"17",    rate:"10%", time:"morning"},
      {name:"Ditto",      method:"Grass",     levels:"17",    rate:"10%", time:"day"},
...
const DT_ABILITIES = {
  ...
  "Steelix":    { name:"Rock Head",      desc:"No recoil from recoil moves — enables Double-Edge at full power (Sturdy in Gen IV only blocks OHKO moves, not general KOs)" },
  "Scizor":     { name:"Technician",    desc:"Moves with base power ≤ 60 deal 1.5× damage — Bullet Punch, U-turn, etc." },
  "Donphan":    { name:"Sturdy",        desc:"Cannot be OHKOed by one-hit KO moves (only ability in Gen IV — Sand Veil is the Gen V Hidden Ability, unavailable in HGSS)" },
  ...
  "Porygon2":   { name:"Download",      desc:"Raises Attack or Sp. Atk by one stage based on the opponent's weaker defense — almost always boosts Sp. Atk in practice" },
  ...
  "Murkrow":    { name:"Super Luck",    desc:"Raises critical-hit ratio — stacks with Night Slash's high crit rate for frequent crits (Insomnia is the other option if sleep is a concern)" },
...
const SAFARI_BALL_AREA_IDS = new Set([
  "safari-zone-peak","safari-zone-desert","safari-zone-plains","safari-zone-meadow",
...
// trade:true → trade evolution; breed:true → hatched from egg; otherwise level/stone evo
const EXCL_EVO_INFO = {
        ...
        {!area ? (
          ...
          <>
            ...
            <div key={area.id} className="hgss-area-in" style={{ padding:"14px 20px 20px", position:"relative" }}>
              ...
              {area.image && (
                <a href={area.image} target="_blank" rel="noopener noreferrer" style={{ display:"block", marginBottom:14 }}>
                  <img src={area.image} alt={`${area.name} map`} loading="lazy"
                    style={{ width:"100%", maxHeight:220, objectFit:"cover", objectPosition:"top",
